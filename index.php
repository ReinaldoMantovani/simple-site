...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-inverse top-fixed">
      <div class="container-fluid">
          <button type="button" class="navbar-toggle collapsed bg-info" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
        ...
        <div class="container chamada-banner">
          <div class="row">
              <div class="col-md-12 text-center">
                  <h2><?php echo htmlentities('<'); ?> Web-Dev <?php echo htmlentities('/>');  ?></h2>
                  <p>Empresa voltada para desenvolvimento websites</p>
                  <a href="">Saiba Mais!</a>
              </div><!--col-md-12-->
          </div><!--row-->
        </div>
